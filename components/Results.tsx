...
export default function Results({ lang }: ResultsProps) {
  ...
  return (
    <section className={`py-28 bg-[#030712] relative overflow-hidden ${isRtl ? "rtl" : "ltr"}`}>
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_50%,rgba(14,165,233,0.07),transparent)]" />
          ...
          {results.map((r, i) => {
            ...
            return (
              <motion.div key={i}
                ...
                className="group relative bg-white/5 border border-white/10 hover:bg-white/8 hover:border-white/18 rounded-3xl p-7 transition-all duration-400 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-slate-200 font-bold text-base mb-1">{r.label}</div>
